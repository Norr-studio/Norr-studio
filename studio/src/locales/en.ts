const en = {
  ...
  contact: {
    ...
    subheading: "Fill in a few details and we'll come back to you with a clear plan — no jargon, no pressure.",
    fieldName: 'Name',
    fieldEmail: 'Email',
    ...
    budgetRanges: ['Under 1k€', '1k€ – 3k€', '3k€+'],
    sending: 'Sending…',
    send: 'Send message',
  ...
  work: {
    ...
    moreCaseStudies: 'More case studies available on request — each project is presented in a dedicated deck.',
    bookCall: 'Book a call',
  },
